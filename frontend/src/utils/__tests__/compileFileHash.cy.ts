...
describe('computeFileHash', () => {
  ...
  const stringToArrayBuffer = (str: string): ArrayBuffer => {
    return stringToUint8Array(str).buffer as ArrayBuffer;
  };
  ...
  describe('Basic functionality with default SHA-256', () => {
    it('should compute SHA-256 hash for simple text', async () => {
      ...
      const hash = await computeFileHash(input as BufferSource);
    ...
    it('should produce consistent results for same input', async () => {
      ...
      const hash1 = await computeFileHash(input as BufferSource);
      const hash2 = await computeFileHash(input as BufferSource);
  ...
  describe('Different input types (BufferSource)', () => {
    ...
    it('should work with different typed arrays', async () => {
      ...
      const hash8 = await computeFileHash(uint8Input as BufferSource);
      const hash16 = await computeFileHash(uint16Input as BufferSource);
      const hash32 = await computeFileHash(uint32Input as BufferSource);
  ...
  describe('Different hash algorithms', () => {
    it('should work with SHA-1 algorithm', async () => {
      ...
      const hash = await computeFileHash(input as BufferSource, 'SHA-1');
    ...
    it('should work with SHA-384 algorithm', async () => {
      const input = stringToUint8Array('test');
      const hash = await computeFileHash(input as BufferSource, 'SHA-384');
    ...
    it('should work with SHA-512 algorithm', async () => {
      const input = stringToUint8Array('test');
      const hash = await computeFileHash(input as BufferSource, 'SHA-512');
    ...
    it('should produce different hashes for different algorithms', async () => {
      ...
      const sha1Hash = await computeFileHash(input as BufferSource, 'SHA-1');
      const sha256Hash = await computeFileHash(input as BufferSource, 'SHA-256');
      const sha512Hash = await computeFileHash(input as BufferSource, 'SHA-512');
  ...
  describe('Large data handling', () => {
    it('should handle large data efficiently', async () => {
      ...
      const hash = await computeFileHash(largeData as BufferSource);
    ...
    it('should handle binary data correctly', async () => {
      ...
      const hash = await computeFileHash(binaryData as BufferSource);
  ...
  describe('Error handling and edge cases', () => {
    it('should handle zero-length arrays', async () => {
      ...
      const hash = await computeFileHash(emptyArray as BufferSource);
    ...
    it('should reject invalid algorithm', async () => {
      ...
      try {
        await computeFileHash(input as BufferSource, 'INVALID-ALGORITHM' as AlgorithmIdentifier);
      } catch (error) {
        errorThrown = true;
  ...
  describe('Real-world scenarios', () => {
    it('should simulate file hash computation', async () => {
      ...
      const hash = await computeFileHash(fileContent as BufferSource);
      ...
      const hash2 = await computeFileHash(fileContent as BufferSource);
